...
'''
#  训练数据图像路径
train_image_path = "F:\\IAILD\\AerialImageDataset\\train\\images"
#  训练数据标签路径
train_label_path = "F:\\IAILD\\AerialImageDataset\\train\\gt"
#  验证数据图像路径
validation_image_path = "F:\\IAILD\\AerialImageDataset\\test1\\images"
#  验证数据标签路径
validation_label_path = "F:\\IAILD\\AerialImageDataset\\test1\\gt"
...
classNum = 2
#  模型输入图像大小
input_size = (5000, 5000, 3)  # (512, 512, 3)
#  训练模型的迭代总轮数
epochs = 100
#  初始学习率
learning_rate = 1e-4
...
premodel_path = None
#  训练模型保存地址
model_path = "E:\\Haohai\\laoshan\\unet_model1.hdf5"
